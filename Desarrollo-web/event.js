...
// 7 pregunta
      ...
      if (result == 'si' && result2 == 'si' && result3 == 'si' && result4 == 'si' && result5 == 'si' && result6 == 'si' && result7 == 'si') {
          window.open("./1-recompensa")
      }else {
        document.getElementById('testResult').innerHTML = `<br><p>Una o más de las respuesta es incorrecta. Por favor revisa de nuevo y sigue intentandolo.</p><br>`
      }
}
